...
import { QnDataTable } from '../../lib'
import data from '../test-data/table-data.json'
import { ref } from 'vue'
...
const columns = [
  ...
  { key: 'amount2', title: 'amount2', width: 200 },
  { key: 'createTime', title: 'createTime', width: 200 },
  { key: 'action', title: 'action', width: 200, fixed: 'right' },
]
